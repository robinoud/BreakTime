...
extern string periodBegin   ="00:00:00";
extern string periodEnd     ="02:00:00";
extern string BoxEnd        ="";
extern int    BoxBreakOut_Offset=0;
extern color  BoxHLColor        = CLR_NONE;
extern color  BoxBreakOutColor  = CLR_NONE;
...
//+------------------------------------------------------------------+
  void init() 
  {
   ...
   SetIndexLabel(1,"PriceHight");
   SetIndexLabel(2,"PriceLow");
...
//---- Period Rectangle
     if(iForm==4)
     {
      ...
      ExtMapBuffer1[iBarEnd]= dPriceHigh ;
      ExtMapBuffer2[iBarEnd]= dPriceLow ;
     }
